...
<!--                <source type="image/webp" srcset="--><?php //=$arItem["PREVIEW_PICTURE"]["SRC"]?><!--"><img class="picture__img" src="--><?php //=$arItem["PREVIEW_PICTURE"]["SRC"]?><!--">-->
<!--            </picture>-->
<!--        </div>-->
...
<pre><? var_dump($arResult['PROPERTIES']); ?></pre>
<pre><? var_dump($arResult['ITEMS']['2']['PROPERTIES']['mobile_image']); ?></pre>
