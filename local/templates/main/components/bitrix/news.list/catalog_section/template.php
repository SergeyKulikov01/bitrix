...
?>
<form class="popup-filters mobile" data-popup-wrapper="catalog-filters" data-overlay-on>
    ...
    <div class="popup-filters__top">
        ...
        <div class="popup-filters__tops"><label class="catalog-hero__tops" for="top">
                <input class="catalog-hero__tops-input" type="checkbox" name="top" value="Y" id="top" <? if ($_REQUEST["top"] == "Y") {
                                                                                                            echo "checked";
                                                                                                        }; ?>>
        ...
        <div class="popup-filters__selects">
            <div class="catalog-hero__select">
                <div class="select-wrapper">
                    <div class="select"><select class="select__select" style="width: 100%" data-select-placeholder="Бренд" name="brand" id="mobile">
            ...
            <div class="catalog-hero__select">
                <div class="select-wrapper">
                    <div class="select"><select class="select__select" style="width: 100%" data-select-placeholder="Жирность" name="fat">
                            <option value="" selected="selected" disabled="disabled"></option>
    ...
    <div class="popup-filters__bot">
        ...
        <div class="popup-filters__bot-btn">
            <div class="popup-filters__button" name="submit_mobile">Применить</div>
        </div>
    </div>
</form>
...
<section class="catalog-hero top-section container">
    ...
    <div class="catalog-hero__thumbs">
        <div class="catalog-hero__thumbs-item btn-hover_parent <? if ($arResult["SECTION"]["CODE"] == $arResult["MAIN_SECTION"]["CODE"]) {
                                                                    echo "active";
                                                                } ?>">
            <a href="<?= $arResult["MAIN_SECTION"]["SECTION_PAGE_URL"] ?>">
                <div class="btn-hover_circle"></div><span>Все</span>
            </a>
        </div>
        <? foreach ($arResult["SECTIONS"] as $arItem) : ?>
            <div class="catalog-hero__thumbs-item btn-hover_parent <? if ($arResult["SECTION"]["CODE"] == $arItem["CODE"]) {
                                                                        echo "active";
                                                                    } ?>">
                <a href="<?= $arItem['SECTION_PAGE_URL'] ?>">
                    <div class="btn-hover_circle"></div><span><?= $arItem['NAME'] ?></span>
                </a>
            </div>
        <? endforeach; ?>
    </div>
    <form class="catalog-hero__activity" data-aos="fade-up" data-device="desktop">
        <label class="catalog-hero__tops desktop" for="top">
            <input class="catalog-hero__tops-input catalog-check-desktop" type="checkbox" name="top" value="Y" id="top" data-device="desktop" <? if ($_REQUEST["top"] == "Y") {
                                                                                                                                                    echo "checked";
                                                                                                                                                }; ?>>
            <div class="catalog-hero__tops-box"><svg class="mark-svg" xmlns="http://www.w3.org/2000/svg" width="14" height="10" viewbox="0 0 14 10" fill="none">
                    <path d="M1 5L5 9L13 1" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
        ...
        <div class="catalog-hero__selects">
            <? if (isset($arResult["FILTER_LIST"]["BRAND"])) : ?>
                <div class="catalog-hero__select desktop">
                    <div class="select-wrapper">
                        <div class="select">
                            <select class="select__select" style="width: 100%" data-select-placeholder="Бренд" name="brand" data-device="desktop">
                                <option value="" selected="selected" disabled="disabled"></option>
                                <? foreach ($arResult["FILTER_LIST"]["BRAND"] as $key => $item) : ?>
                                    <option value="<?= $key ?>" <? if ($_REQUEST["brand"] == $key) {
                                                                    echo "selected";
            ...
            <? if (isset($arResult["FILTER_LIST"]["FAT"])) : ?>
                <div class="catalog-hero__select desktop">
                    <div class="select-wrapper">
                        <div class="select">
                            <select class="select__select" style="width: 100%" data-select-placeholder="Жирность" name="fat" data-device="desktop">
                                <option value="" selected="selected" disabled="disabled"></option>
                                <? foreach ($arResult["FILTER_LIST"]["FAT"] as $key => $item) : ?>
                                    <option value="<?= $item ?>" <? if ($_REQUEST["fat"] == $item) {
                                                                        echo "selected";
        ...
        <? foreach ($arResult["ITEMS"] as $arItem) : ?>
            <a class="catalog-card" href="<?= $arItem["DETAIL_PAGE_URL"] ?>">
                <div class="catalog-card__icons">
                    <? foreach ($arItem["DISPLAY_PROPERTIES"]["icons"]["VALUE"] as $key => $icon) : ?>
                        <? if ($icon == 'new') : ?>
                    ...
                    <div class="catalog-card__bot">
                        ...
                        <div class="catalog-card__plugs">
                            <div class="catalog-card__plug">
                                ...
                                <div class="catalog-card__plug-text"><?= $arItem["DISPLAY_PROPERTIES"]["WEIGHT"]["DISPLAY_VALUE"] ?> г</div>
                            ...
                            <div class="catalog-card__plug">
                                ...
                                <div class="catalog-card__plug-text"><?= $arItem["DISPLAY_PROPERTIES"]["CNT_IN_BOX"]["DISPLAY_VALUE"] ?> шт</div>
                                <div class="catalog-card__plug-info"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none">
                                        <rect x="0.5" y="0.5" width="23" height="23" rx="5.5" fill="white"></rect>
                                        <path d="M12.75 11C12.75 10.5858 12.4142 10.25 12 10.25C11.5858 10.25 11.25 10.5858 11.25 11V17C11.25 17.4142 11.5858 17.75 12 17.75C12.4142 17.75 12.75 17.4142 12.75 17V11Z" fill="#0068FF"></path>
                                        <path d="M13 8C13 8.55228 12.5523 9 12 9C11.4477 9 11 8.55228 11 8C11 7.44772 11.4477 7 12 7C12.5523 7 13 7.44772 13 8Z" fill="#0068FF"></path>
                            ...
                            <div class="catalog-card__plug">
                                ...
                                <div class="catalog-card__plug-text"><?= $arItem["DISPLAY_PROPERTIES"]["BOXES"]["DISPLAY_VALUE"] ?> шт</div>
                                <div class="catalog-card__plug-info"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none">
                                        <rect x="0.5" y="0.5" width="23" height="23" rx="5.5" fill="white"></rect>
                                        <path d="M12.75 11C12.75 10.5858 12.4142 10.25 12 10.25C11.5858 10.25 11.25 10.5858 11.25 11V17C11.25 17.4142 11.5858 17.75 12 17.75C12.4142 17.75 12.75 17.4142 12.75 17V11Z" fill="#0068FF"></path>
                                        <path d="M13 8C13 8.55228 12.5523 9 12 9C11.4477 9 11 8.55228 11 8C11 7.44772 11.4477 7 12 7C12.5523 7 13 7.44772 13 8Z" fill="#0068FF"></path>
