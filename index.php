...
?>
                    ...
                    <div class="swiper main-swiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide main-slider__slide">
                                <div class="main-slider__slide-bg desktop" data-swiper-parallax="1440" data-bg-parallax>
                                    <picture class="picture">
                                        <source type="image/webp" srcset="assets/images/main-slider-bg1.webp"><img class="picture__img" src="assets/images/main-slider-bg1.png">
                                    </picture>
                                </div>
                            ...
                            <div class="swiper-slide main-slider__slide">
                                <div class="main-slider__slide-bg desktop" data-swiper-parallax="1440" data-bg-parallax>
                                    <picture class="picture">
                                        <source type="image/webp" srcset="assets/images/main-slider-bg2.webp"><img class="picture__img" src="assets/images/main-slider-bg2.png">
                                    </picture>
                                </div>
                                <div class="main-slider__slide-bg devices">
                                    <picture class="picture">
                            ...
                            <div class="swiper-slide main-slider__slide">
                                <div class="main-slider__slide-bg desktop" data-swiper-parallax="1440" data-bg-parallax>
                                    <picture class="picture">
                                        <source type="image/webp" srcset="assets/images/main-slider-bg3.webp"><img class="picture__img" src="assets/images/main-slider-bg3.png">
                                    </picture>
                                </div>
                                <div class="main-slider__slide-bg devices">
                                    <picture class="picture">
                            ...
                            <div class="swiper-slide main-slider__slide">
                                <div class="main-slider__slide-bg desktop" data-swiper-parallax="1440" data-bg-parallax>
                                    <picture class="picture">
                                        <source type="image/webp" srcset="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-slider-bg4.webp"><img class="picture__img" src="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-slider-bg4.png">
                                    </picture>
                                </div>
                                <div class="main-slider__slide-bg devices">
                                    <picture class="picture">
                            ...
                            <div class="swiper-slide main-slider__slide">
                                <div class="main-slider__slide-bg desktop" data-swiper-parallax="1440" data-bg-parallax>
                                    <picture class="picture">
                                        <source type="image/webp" srcset="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-slider-bg5.webp"><img class="picture__img" src="assets/images/main-slider-bg5.png">
                                    </picture>
                                </div>
                                <div class="main-slider__slide-bg devices">
                                    <picture class="picture">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide main-slider__slide">
                                <div class="main-slider__slide-bg mobile bg-bg-bg">
                                    <picture class="picture">
                                        <source type="image/webp" srcset="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-slider-bg1-mobile.webp"><img class="picture__img" src="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-slider-bg1-mobile.png">
                                    </picture>
                                </div>
                                <div class="main-slider__content">
                            ...
                            <div class="swiper-slide main-slider__slide">
                                <div class="main-slider__slide-bg mobile bg-bg-bg">
                                    <picture class="picture">
                                        <source type="image/webp" srcset="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-slider-bg2-mobile.webp"><img class="picture__img" src="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-slider-bg2-mobile.png">
                                    </picture>
                                </div>
                                <div class="main-slider__content">
                                    <div class="main-slider__content-icon"><svg xmlns="http://www.w3.org/2000/svg" width="100" height="70" viewbox="0 0 100 70" fill="none">
                            ...
                            <div class="swiper-slide main-slider__slide">
                                <div class="main-slider__slide-bg mobile bg-bg-bg">
                                    <picture class="picture">
                                        <source type="image/webp" srcset="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-slider-bg3-mobile.webp"><img class="picture__img" src="assets/images/main-slider-bg3-mobile.png">
                                    </picture>
                                </div>
                                <div class="main-slider__content">
                                    <div class="main-slider__content-icon"><svg xmlns="http://www.w3.org/2000/svg" width="100" height="70" viewbox="0 0 100 70" fill="none">
                            ...
                            <div class="swiper-slide main-slider__slide">
                                <div class="main-slider__slide-bg mobile bg-bg-bg">
                                    <picture class="picture">
                                        <source type="image/webp" srcset="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-slider-bg4-mobile.webp"><img class="picture__img" src="assets/images/main-slider-bg4-mobile.png">
                                    </picture>
                                </div>
                                <div class="main-slider__content">
                                    <div class="main-slider__content-icon"><svg xmlns="http://www.w3.org/2000/svg" width="100" height="70" viewbox="0 0 100 70" fill="none">
                            ...
                            <div class="swiper-slide main-slider__slide">
                                <div class="main-slider__slide-bg mobile bg-bg-bg">
                                    <picture class="picture">
                                        <source type="image/webp" srcset="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-slider-bg5-mobile.webp"><img class="picture__img" src="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-slider-bg5-mobile.png">
                                    </picture>
                                </div>
                                <div class="main-slider__content">
                                    <div class="main-slider__content-icon"><svg xmlns="http://www.w3.org/2000/svg" width="100" height="70" viewbox="0 0 100 70" fill="none">
        ...
        <section class="main-catalog container" data-aos="fade-up" data-aos-duration="1500">
            ...
            <div class="main-catalog__list" data-aos="fade-up" data-aos-duration="1500"><a class="main-catalog__item btn-hover_parent" href="#">
                    <div class="main-catalog__item-bg desktop">
                        <picture class="picture">
                            <source type="image/webp" srcset="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg1.webp"><img class="picture__img" src="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg1.png">
                        </picture>
                    </div>
                    <div class="main-catalog__item-bg mobile">
                        <picture class="picture">
                            <source type="image/webp" srcset="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg1-mobile.webp"><img class="picture__img" src="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg1-mobile.png">
                        </picture>
                    </div>
                    ...
                    <div class="main-catalog__item-bg desktop">
                        <picture class="picture">
                            <source type="image/webp" srcset="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg2.webp"><img class="picture__img" src="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg2.png">
                        </picture>
                    </div>
                    <div class="main-catalog__item-bg mobile">
                        <picture class="picture">
                            <source type="image/webp" srcset="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg2-mobile.webp"><img class="picture__img" src="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg2-mobile.png">
                        </picture>
                    </div>
                    <div class="main-catalog__item-row">
                    ...
                    <div class="main-catalog__item-bg desktop">
                        <picture class="picture">
                            <source type="image/webp" srcset="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg3.webp"><img class="picture__img" src="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg3.png">
                        </picture>
                    </div>
                    <div class="main-catalog__item-bg mobile">
                        <picture class="picture">
                            <source type="image/webp" srcset="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg3-mobile.webp"><img class="picture__img" src="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg3-mobile.png">
                        </picture>
                    </div>
                    <div class="main-catalog__item-row">
        ...
        <section class="main-traditions container-fluid" data-aos="fade-up" data-aos-duration="1500">
            ...
            <div class="container" data-aos="fade-up" data-aos-duration="1500">
                ...
                <div class="main-traditions__video" data-button-fade="main-video">
                    ...
                    <div class="main-traditions__video-video"><video src="<?php echo SITE_TEMPLATE_PATH ?>/assets/videos/zp_preview.mp4" loop muted playsinline autoplay preload="none"></video></div>
        ...
        <section class="main-filials container" data-aos="fade-up" data-aos-duration="1500">
            <div class="main-filials__landscape" data-aos="fade-up" data-aos-duration="1500">
                <div class="main-filials__landscape-bg desktop">
                    <picture class="picture">
                        <source type="image/webp" srcset="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-filials-bg.webp"><img class="picture__img" src="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-filials-bg.png">
                    </picture>
                </div>
                <div class="main-filials__landscape-bg devices">
                    <picture class="picture">
                        <source type="image/webp" srcset="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-filials-bg-device.webp"><img class="picture__img" src="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-filials-bg-device.png">
                    </picture>
                </div>
                <div class="main-filials__landscape-bg mobile-mob">
                    <picture class="picture">
                        <source type="image/webp" srcset="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-filials-bg-mobile.webp"><img class="picture__img" src="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-filials-bg-mobile.png">
                    </picture>
                </div>
                ...
                <h2 class="main-filials__landscape-title animation-title" data-splitting data-effect1><span>развитая </span><span>сбытовая </span><span>сеть </span><span>из </span><span>10 </span><span>филиалов</span></h2>
                <div class="main-filials__landscape-content">
                    ...
                    <div class="main-filials__landscape-desk">Присоединяйтесь к нам!</div><a class="main-filials__landscape-button btn-hover_parent" href="#">
                        <div class="btn-hover_circle white"></div>
            ...
            <div class="main-filials__bottom" data-aos="fade-up" data-aos-duration="1500"><a class="main-filials__card where-buy btn-hover_parent" href="#">
                    ...
                    <div class="main-filials__card-bot">
                        <div class="main-filials__card-row">
                            <div class="main-filials__card-icons">
                                <picture class="picture">
                                    <source type="image/webp" srcset="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-filials-card-icons1.webp"><img class="picture__img" src="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-filials-card-icons1.png">
                                </picture>
                            </div>
                            <div class="button button-arrow_right btn-hover_parent">
                                <div class="btn-hover_circle total-white"></div><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none">
                    ...
                    <div class="main-filials__card-bg">
                        <picture class="picture">
                            <source type="image/webp" srcset="assets/images/main-filials-game.webp"><img class="picture__img" src="assets/images/main-filials-game.png">
                        </picture>
                    </div>
                    <div class="main-filials__card-top">
                    ...
                    <div class="main-filials__card-bot">
                        <div class="main-filials__card-row">
                            <div class="main-filials__card-icons short">
                                <picture class="picture">
                                    <source type="image/webp" srcset="assets/images/main-filials-card-icons2.webp"><img class="picture__img" src="assets/images/main-filials-card-icons2.png">
                                </picture>
                            </div>
                            <div class="button button-arrow_right btn-hover_parent">
                                <div class="btn-hover_circle total-white"></div><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none">
                        ...
                        <div class="swiper main-news__swiper">
                            <div class="swiper-wrapper"><a class="swiper-slide main-news__card" href="#">
                                    <div class="main-news__card-img">
                                        <picture class="picture">
                                            <source type="image/webp" srcset="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-news-card1.webp"><img class="picture__img" src="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-news-card1.png">
        ...
        <div class="popup-video" data-popup-fade="main-video">
            ...
            <div class="popup-video__inner">
                <div class="popup-video__video"><video class="zp-video" controls="controls" width="100%" height="100%" poster="./<?php echo SITE_TEMPLATE_PATH ?>/assets/images/about-production-popup-icecream.png" preload="none">
